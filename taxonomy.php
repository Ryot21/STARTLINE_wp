	...
	<div id="container">
		<main id="main">
			...
			<article class="l-container">
				<h2 class="archive-ttl main-font">WORKS</h2>
				<p class="single-sub-ttl sub-font">こちらには一部の制作実績をご紹介いたします。</p>
				<div class="work-box">


				<ul class="cat-lists">
					<!-- 投稿されているWORKSの全てを表示 -->
					<li class="cat-list"><a href="/works/">全て</a></li>

					<!-- 実際に投稿されているカテゴリーを表示する -->
					<?php
						// ↓↓ get_terms()内にはtaxonomyを入れる
						$terms = get_terms('cording');
